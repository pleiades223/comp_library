...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"template/template-code.cpp\"\n#if __INCLUDE_LEVEL__ == 0\n\
  ...
  verifiedWith: []
documentation_of: template/template-code.cpp
layout: document
redirect_from:
- /library/template/template-code.cpp
- /library/template/template-code.cpp.html
